...
const TestimonialArea = () => {
  ...
  return (
    <>
      <section className="mt-20 testimonial-area-6 gap-bottom-equal">
            ...
            <div className="col-lg-6">
              ...
              >
                <div className="thumbnail">
                  <img
                    src="https://stimg2.cardekho.com/images/carNewsimages/userimages/32375/1713580265426/GeneralNew.jpg?tr=w-360"
                    alt="Thumb"
                  />
                  <button
