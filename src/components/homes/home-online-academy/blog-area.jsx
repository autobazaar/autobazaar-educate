...
const BlogArea = () => {
  return (
    <div className="mb-20 edu-blog-area blog-area-8 edu-section-gap">
      <div className="container">
        ...
        >
          ...
          <h2 className="title">Interesting Articles @ AutoBazaar Blog</h2>
              ...
              <div className="inner">
                <div className="thumbnail">
                  <Link href={`/blog-details/${large_blog.id}`}>
                    <a>
                      <img
                        src="https://static01.nyt.com/images/2021/12/10/multimedia/00wheels-used-1/00wheels-used-1-superJumbo.jpg?quality=75&auto=webp"
                        alt="Blog Images"
                      />
                    </a>
                  </Link>
